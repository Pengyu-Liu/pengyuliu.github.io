...
### 30 Jan
Found out the index of the pixel that SVD didn't converge. Still don't know the reason. Made TRAP run on upper and lower PSF cube on the servers. It needed 5 hours to run.
