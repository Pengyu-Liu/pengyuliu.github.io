...
### 22 Oct 2020
Started to write the fake planet routine. Have some questions about how to implement the algorithm. The main problem is how to minize the function: use the downhill simplex method(I just learned it in NUR) or simple iterations?
